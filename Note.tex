...
\begin{document}
	...
	\noindent The following theorem is essentially a double application of \textbf{Proposition 13.30} of \cite{Bauschke2010} where extra conditions are imposed to guarantee $g^{**}$ is proper. As with \cite{Bauschke2010}, we allow $\sup\{\cdot\}$ to take values $\pm\infty$.
